                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form method="post" action="{{ route("password.update") }}" class="space-y-4 md:space-y-6">
                            ...
                            <div>
                                ...
                                <input  type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                                @error('password')
                                <p class="text-red-700 text-sm ml-2 mt-1 mb-2 absolute ">{{ $message }}</p>
                                @enderror
                            </div>
