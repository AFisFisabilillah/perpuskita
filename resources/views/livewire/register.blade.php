            ...
            <div class="w-full bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 relative">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-200 dark:text-white">Your Name</label>
                            <input wire:model="name" type="" name="name" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500  relative" placeholder="name" required autocomplete="off">
                        </div>
                        <div>
                        ...
                        <button type="button" wire:click="register" class="w-full text-white bg-primary hover:bg-primary-700 focus:ring-2 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary dark:hover:bg-primary-700 dark:focus:ring-primary-800 mt-2">
                            <p wire:loading.remove>Sign in</p>
                            <img wire:loading wire:target="register" src="{{ asset('img/loading.gif') }}" alt="loading" class="size-6">
                        </button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Do you have an account yet? <a wire:navigate href="{{ route('login') }}" class="font-medium text-primary hover:underline dark:text-primary-500">Sign up</a>
